...
saple_obj <- readRDS("../results_data/saple_obj_har_before.rds") 
...
saveRDS(saple_obj,file = "../results_data/saple_obj_har_after.rds")

#save figures
pdf("../results_figures/seurat_clusters_har_after.pdf" )
...
pdf("../results_figures/samples_har_after.pdf" )
DimPlot(saple_obj, reduction = "umap",group.by = "samples" ,cols =  cols)
dev.off()

pdf("../results_figures/Phase_har_after.pdf" )
DimPlot(saple_obj, reduction = "umap",group.by = "Phase" )
dev.off()

pdf("../results_figures/orig.ident_har_after.pdf" )
